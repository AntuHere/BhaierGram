...
let show_contact = document.getElementById("show_contact")
function toggle(){
  document.getElementById('contacts').classList.toggle("hover");
  document.getElementById('chat').classList.toggle('chatTranslate')
  console.log('hello');
}